...
interface InstitutionAdminShellProps {
  children: React.ReactNode
  navItems: InstitutionAdminNavItem[]
  title: string
  description?: string
  allowedRoles?: string[]
...
export function InstitutionAdminShell({
  ...
  navItems,
  title,
  description = "Manage your tuition center",
  allowedRoles = ["institution_admin"],
  notificationItems = [],
}: InstitutionAdminShellProps) {
              ...
              <DropdownMenu>
                ...
                >
                  <div className="border-b border-[#A2D4ED]/40 bg-[#f4f7fb] px-3 py-2.5">
                    ...
                    <p className="text-xs text-[#0047AB]/70">Center activity updates</p>
                  </div>
