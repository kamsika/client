...
import type { Institution, InstitutionNotificationSettings } from "@/types"
...
export function AdminInstitutionPage() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      toast.error(getApiErrorMessage(error, "Failed to load institution settings"))
    } finally {
      setLoading(false)
    }
  }, [])
  ...
  return (
    <InstitutionAdminShell
      title="Institution"
      description="Manage your institution profile, branding, and notifications"
